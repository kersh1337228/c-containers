...
[[nodiscard]] hash_map *hash_map_init(size_t, hash_t, comparator_t);
[[nodiscard]] size_t hash_map_size(const hash_map *);
void hash_map_insert(hash_map *, size_t, const void *, size_t, const void *, unsigned char);
void hash_map_remove(hash_map *, size_t, const void *, unsigned char);
[[nodiscard]] node_data *hash_map_at(const hash_map *, size_t, const void *);
